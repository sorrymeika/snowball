...
import { isFunction, isObject, isArray, isPlainObject, isString, camelCase } from '../utils';
...
var Zepto = (function () {
    ...
    zepto.init = function (selector, context) {
        ...
        else if (isFunction(selector)) throw new Error('bad selector!');
    ...
    adjacencyOperators.forEach(function (operator, operatorIndex) {
        ...
        $.fn[operator] = function () {
            ...
            var nodes = $.map(arguments, function (arg) {
                return isObject(arg) || isArray(arg) || arg == null ?
        ...
        return $this.each(function (_, element) {
            ...
            if (selector) delegator = function (e) {
                ...
                if (match && match !== element) {
                    evt = Object.assign(createProxy(e), { currentTarget: match, liveFired: element });
